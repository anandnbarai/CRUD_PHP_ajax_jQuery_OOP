...
<script>
    // Get the country and state dropdowns
    ...
    // When the country dropdown changes, get the selected country code.
    ...
    //                 // $('#state').append(state);
    //                 stateDropdown.innerHTML += `<option value="${state.id}">${state.StateName}</option>`;
    //                 console.log(data);
    //                 // console.log(stateDropdown.innerHTML);
